...
<style>
.stat-card{border:none;box-shadow:0 2px 12px rgba(0,0,0,.08);border-radius:12px;transition:.2s;}
...
.section-head{font-size:13px;font-weight:700;color:#1a237e;border-left:3px solid #1a237e;padding-left:8px;margin-bottom:12px;}
.dash-table th{font-size:11px;font-weight:600;color:#666;text-transform:uppercase;}
.dash-table td{font-size:12px;vertical-align:middle;}
.quick-link{display:flex;align-items:center;gap:10px;padding:10px 14px;border-radius:10px;border:1.5px solid #e2e8f0;text-decoration:none;color:#374151;font-size:13px;font-weight:600;transition:.15s;}
.quick-link:hover{background:#f8fafc;border-color:#6366f1;color:#4f46e5;transform:translateX(3px);}
.quick-link i{font-size:18px;width:24px;text-align:center;}
</style>
...
<div class="container-fluid">
  ...
  <div class="row g-3 mb-4">
    ...
    <div class="col-md-4">
      <div class="card custom-card shadow-sm h-100">
        <div class="card-header"><div class="card-title mb-0"><i class="ri-flashlight-line me-2 text-warning"></i>Quick Actions</div></div>
        <div class="card-body p-3">
          ...
          <div class="table-responsive">
            <table class="table table-hover dash-table mb-0">
              <thead class="table-light">
                <tr><th>#</th><th>Date</th><th>Vehicle</th><th>Route</th><th>Type</th><th>Freight</th><th>Status</th></tr>
              </thead>
              <tbody>
      ...
      <div class="card custom-card shadow-sm">
        ...
        <div class="card-body p-0">
          ...
          <div class="table-responsive">
            <table class="table table-hover dash-table mb-0">
              <thead class="table-light">
                <tr><th>Bill No.</th><th>Party</th><th>Net Amt</th><th>Due</th><th>Status</th></tr>
              </thead>
              <tbody>
