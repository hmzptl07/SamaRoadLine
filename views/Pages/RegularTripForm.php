...
$consigners     = array_filter($parties,  fn($p) => in_array($p["PartyType"], ["Consigner", "Both"]) && $p["IsActive"] === "Yes");
                ...
                <div class="col-xl-8">
                    ...
                    <div class="trip-card">
                        <div class="trip-card-head">
                            ...
                            <button type="button" class="btn btn-success btn-sm" onclick="addRow()" style="border-radius:7px;font-size:12px;padding:4px 12px;">
                            ...
                            <table class="table mb-0" id="matTable">
                                ...
                                <tbody id="matBody">
                                    <?php if (empty($materials)): ?>
                                        <tr>
                                            ...
                                            <td><input type="number" step="0.01" name="Amount[]" class="form-control form-control-sm amt text-center" style="background:#f8fafc;" readonly></td>
                                        ...
                                        <?php else: foreach ($materials as $m): ?>
                                            <tr>
                                                ...
                                                <td><input type="number" step="0.01" name="Amount[]" class="form-control form-control-sm amt text-center" value="<?= $m["Amount"] ?>" style="background:#f8fafc;" readonly></td>
                                                <td><button type="button" class="btn btn-sm btn-outline-danger" onclick="delRow(this)" style="width:30px;height:30px;padding:0;"><i class="ri-delete-bin-line" style="font-size:13px;"></i></button></td>
                                            </tr>
                                    <?php endforeach;
                                    endif; ?>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><input id="totWt" class="form-control form-control-sm fw-bold text-center" style="background:#f0f4ff;border-color:#c7d7fc;" readonly></td>
                                        <td></td>
                                        <td><input id="matAmt" class="form-control form-control-sm fw-bold text-center" style="background:#f0f4ff;border-color:#c7d7fc;" readonly></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
