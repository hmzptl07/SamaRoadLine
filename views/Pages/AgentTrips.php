...
.ph-sub   { font-size: 12px; color: rgba(255,255,255,.65); margin-top: 3px; }

.stats-bar { display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 20px; }
.stat-pill {
    background: #fff; border: 1px solid #e2e8f0; border-radius: 10px;
    padding: 10px 18px; display: flex; align-items: center; gap: 10px;
    box-shadow: 0 1px 4px rgba(0,0,0,.05); flex: 1; min-width: 120px;
}
...
.sp-val  { font-size: 20px; font-weight: 800; color: #92400e; line-height: 1; }
...
.amber-head th {
    ...
    font-size: 12px; font-weight: 700; padding: 10px 12px; border: none; white-space: nowrap;
}
.card-table { border-radius: 0 0 12px 12px; border-top: none; overflow: hidden; }

.status-open   { background:#dbeafe;color:#1d4ed8;border:1px solid #bfdbfe;padding:3px 9px;border-radius:20px;font-size:10px;font-weight:700; }
.status-closed { background:#dcfce7;color:#15803d;border:1px solid #bbf7d0;padding:3px 9px;border-radius:20px;font-size:10px;font-weight:700; }
.owner-pending { background:#fef2f2;color:#dc2626;border:1px solid #fecaca;padding:3px 8px;border-radius:20px;font-size:10px;font-weight:700; }
.owner-paid    { background:#dcfce7;color:#16a34a;border:1px solid #bbf7d0;padding:3px 8px;border-radius:20px;font-size:10px;font-weight:700; }
...
<div class="stats-bar">
    <div class="stat-pill">
        ...
        <div><div class="sp-val"><?= $total ?></div><div class="sp-lbl">Total Trips</div></div>
    </div>
    <div class="stat-pill">
        <div class="sp-icon" style="background:#dbeafe;"><i class="ri-time-line" style="color:#1d4ed8;"></i></div>
        <div><div class="sp-val" style="color:#1d4ed8;"><?= $openCount ?></div><div class="sp-lbl">Open</div></div>
    </div>
    <div class="stat-pill">
        <div class="sp-icon" style="background:#dcfce7;"><i class="ri-checkbox-circle-line" style="color:#15803d;"></i></div>
        <div><div class="sp-val" style="color:#15803d;"><?= $closedCount ?></div><div class="sp-lbl">Closed</div></div>
    </div>
    <div class="stat-pill">
    ...
    <div class="stat-pill">
        ...
        <div><div class="sp-val" style="font-size:14px;color:#1a237e;">Rs.<?= number_format($totalNet,0) ?></div><div class="sp-lbl">Total Net</div></div>
    </div>
</div>
...
$(document).ready(function(){
    ...
    $('#fStatus').on('change', function(){ dtTrips.column(9).search(this.value||'').draw(); });
    $('#fOwner').on('change',  function(){ dtTrips.column(8).search(this.value||'').draw(); });
});
            ...
            <div style="font-family:inherit;">
              ...
              <div class="dtab-pane" id="dtab-info" style="display:block;">
                <div class="info-grid">
                  ...
                  <div class="info-cell">
                    <div class="info-lbl">Consignee</div>
                    <div class="info-val">${t.ConsigneeName||'—'}</div>
                    <div class="info-sub">${t.ConsigneeContactNo||''} ${t.ConsigneeCity?'| '+t.ConsigneeCity:''}</div>
                  </div>
                </div>
                <!-- Route -->
