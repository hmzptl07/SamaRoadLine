...
function isActive(string $p): string { global $currentPage; return $currentPage === $p ? ' active' : ''; }
...
?>
<style>
.sama-brand-logo{display:flex!important;align-items:center;text-decoration:none!important;padding:4px 0;}
.sama-logo-full{display:flex;align-items:center;gap:10px;}
.sama-logo-icon{font-size:28px;line-height:1;flex-shrink:0;}
.sama-logo-text{display:flex;flex-direction:column;line-height:1;}
.sama-logo-name{font-size:17px;font-weight:900;color:#1a237e;letter-spacing:.5px;text-transform:uppercase;}
.sama-logo-name2{font-size:10px;font-weight:600;color:#64748b;letter-spacing:2px;text-transform:uppercase;margin-top:1px;}
.sama-logo-mini{display:none;font-size:26px;line-height:1;}
[data-toggled="icon-overlay"] .sama-logo-full,[data-toggled="close"] .sama-logo-full{display:none!important;}
[data-toggled="icon-overlay"] .sama-logo-mini,[data-toggled="close"] .sama-logo-mini{display:inline!important;}
body:not([data-toggled="icon-overlay"]):not([data-toggled="close"]) .app-sidebar .side-menu__label{white-space:normal!important;overflow:visible!important;text-overflow:unset!important;line-height:1.35;word-break:break-word;flex:1;}
body:not([data-toggled="icon-overlay"]):not([data-toggled="close"]) .app-sidebar .side-menu__item{height:auto!important;min-height:40px;padding-top:8px!important;padding-bottom:8px!important;display:flex!important;align-items:center!important;}
body:not([data-toggled="icon-overlay"]):not([data-toggled="close"]) .app-sidebar .side-menu__icon{flex-shrink:0!important;margin-top:0!important;}
body:not([data-toggled="icon-overlay"]):not([data-toggled="close"]) .app-sidebar .side-menu__angle{flex-shrink:0!important;margin-left:auto!important;margin-top:0!important;}
body:not([data-toggled="icon-overlay"]):not([data-toggled="close"]) .app-sidebar .slide-menu .side-menu__item{min-height:36px!important;padding-top:6px!important;padding-bottom:6px!important;}
</style>
